...
";
    ...
    <div class=\"container\">
        <nav class=\"nav nav-pills justify-content-center flex-wrap\">
            <a class=\"nav-link text-dark\" href=\"#audiovisuel\">Audiovisuel</a>
        ...
        <div class=\"row align-items-center mb-4\">
            <div class=\"col-lg-6 scroll-reveal-left\">
                <div class=\"pe-lg-4\">
                    ...
                    <h2 class=\"display-6 font-bold text-primary-blue mb-3\">Audiovisuel</h2>
        ...
        <div class=\"row align-items-center mb-4\">
            <div class=\"col-lg-6 order-lg-2 scroll-reveal-right\">
                <div class=\"ps-lg-4\">
                    ...
                    <p class=\"lead text-dark-gray mb-4\">
                        Location d'équipements multimédia, TV UHD, tablettes, ordinateurs
                    </p>
                    <p class=\"text-dark-gray\">
                        Nous vous proposons de nombreuses références d'équipements.
                    </p>
                </div>
            </div>
...
";
    ...
    {
        return array (  344 => 246,  338 => 243,  331 => 238,  321 => 230,  282 => 193,  247 => 159,  210 => 123,  174 => 88,  133 => 48,  119 => 35,  110 => 27,  91 => 9,  84 => 7,  70 => 5,  55 => 3,  38 => 1,);
    }
...
<section class=\"py-5 bg-primary-blue text-white\">
    <div class=\"container py-5 text-center scroll-reveal\">
        ...
        <div class=\"d-flex gap-3 justify-content-center flex-wrap\">
            ...
            <a href=\"{{ path('contact') }}\" class=\"btn btn-outline-light btn-lg\">
                <i class=\"fas fa-phone me-2\"></i>Nous appeler
            </a>
        </div>
    </div>
