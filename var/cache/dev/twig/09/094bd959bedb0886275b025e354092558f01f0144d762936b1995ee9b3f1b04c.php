                ...
                <div class=\"row mt-5\">
                    <div class=\"col-md-4 text-center mb-4\">
                        <div class=\"contact-info-box p-4\">
                            ...
                            <h5>Téléphone</h5>
                            <p class=\"text-muted\"><a href=\"tel:0668563843\">06 68 56 38 43</a></p>
                        </div>
                    </div>
                    <div class=\"col-md-4 text-center mb-4\">
                        <div class=\"contact-info-box p-4\">
                            ...
                            <h5>Email</h5>
                            <p class=\"text-muted\"><a href=\"mailto:contact@irci-salon.fr\">contact@irci-salon.fr</a></p>
                        </div>
                    </div>
                    <div class=\"col-md-4 text-center mb-4\">
                        <div class=\"contact-info-box p-4\">
                            ...
                            <h5>Localisation</h5>
                            <p class=\"text-muted\">Marseille, France</p>
                        </div>
                    </div>
                </div>
            </div>
