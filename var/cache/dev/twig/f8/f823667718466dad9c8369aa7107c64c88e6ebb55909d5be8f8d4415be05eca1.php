        ...
        <div class=\"row align-items-center\">
            <div class=\"col-lg-8 mx-auto text-center fade-in-up\">
                <h1 class=\"display-4 font-bold mb-3\">
                    <i class=\"fas fa-check text-accent-gold me-3\"></i>
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-lg-10 mx-auto text-center scroll-reveal\">
                <h2 class=\"h3 font-bold text-primary-dark mb-4 text-center\">
                ...
                <p class=\"text-dark-gray\">
                    <strong class=\"text-primary-red\">Livraison, installation et reprise possible.</strong> 
                    Support technique inclus pour vous accompagner dans votre projet.
                </p>
            </div>
        </div>
    </div>
...
";
    ...
    <div class=\"container\">
        <div class=\"nav nav-pills justify-content-center flex-wrap\">
            <a class=\"nav-link text-dark active\" href=\"#all\" data-filter=\"all\">Tout</a>
            <a class=\"nav-link text-dark\" href=\"#sonorisation\" data-filter=\"sonorisation\">Sonorisation</a>
            <a class=\"nav-link text-dark\" href=\"#lumiere\" data-filter=\"lumiere\">Lumière</a>
            <a class=\"nav-link text-dark\" href=\"#multimedia\" data-filter=\"multimedia\">Multimédia</a>
            <a class=\"nav-link text-dark\" href=\"#controle-acces\" data-filter=\"controle-acces\">Contrôle d'accès</a>
        </div>
    </div>
</section>
...
";
    ...
    <div class=\"container py-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            // line 73
            yield "                ";
            $context["categorySlug"] = Twig\Extension\CoreExtension::replace(Twig\Extension\CoreExtension::lower($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["product"], "category", [], "any", false, false, false, 73)), [" " => "-", "é" => "e", "è" => "e", "ê" => "e", "à" => "a", "ô" => "o", "ç" => "c", "'" => ""]);
            // line 74
            yield "                <div class=\"col-md-6 col-lg-4 product-item scroll-reveal-card\" data-category=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["categorySlug"]) || array_key_exists("categorySlug", $context) ? $context["categorySlug"] : (function () { throw new RuntimeError('Variable "categorySlug" does not exist.', 74, $this->source); })()), "html", null, true);
            yield "\" style=\"animation-delay: ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 74) * 0.1), "html", null, true);
            yield "s;\">
                    <a href=\"";
            // line 75
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("rental_product", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["product"], "slug", [], "any", false, false, false, 75)]), "html", null, true);
            yield "\" class=\"text-decoration-none\">
                        <div class=\"product-card h-100\">
                            <div class=\"product-image\">
                                <img src=\"";
            // line 78
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, $context["product"], "image", [], "any", false, false, false, 78)), "html", null, true);
            yield "\" 
                                     alt=\"";
            // line 79
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 79), "html", null, true);
            yield "\" 
            ...
            // line 85
            if ((0 === CoreExtension::compare((isset($context["categorySlug"]) || array_key_exists("categorySlug", $context) ? $context["categorySlug"] : (function () { throw new RuntimeError('Variable "categorySlug" does not exist.', 85, $this->source); })()), "lumiere"))) {
                yield "badge-light";
            } elseif ((0 === CoreExtension::compare((isset($context["categorySlug"]) || array_key_exists("categorySlug", $context) ? $context["categorySlug"] : (function () { throw new RuntimeError('Variable "categorySlug" does not exist.', 85, $this->source); })()), "multimedia"))) {
                yield "badge-video";
            } elseif ((0 === CoreExtension::compare((isset($context["categorySlug"]) || array_key_exists("categorySlug", $context) ? $context["categorySlug"] : (function () { throw new RuntimeError('Variable "categorySlug" does not exist.', 85, $this->source); })()), "controle-acces"))) {
                yield "badge-effects";
            }
            yield "\">";
            ...
            // line 88
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 88), "html", null, true);
            yield "</h3>
                                <p class=\"product-description\">
                                    ";
            // line 90
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["product"], "short_description", [], "any", false, false, false, 90), "html", null, true);
            yield "
                                </p>
...
";
    ...
    {
        return array (  268 => 113,  262 => 110,  255 => 105,  249 => 100,  225 => 90,  220 => 88,  206 => 85,  197 => 79,  193 => 78,  187 => 75,  180 => 74,  177 => 73,  160 => 72,  155 => 69,  141 => 56,  119 => 35,  110 => 27,  91 => 9,  84 => 7,  70 => 5,  55 => 3,  38 => 1,);
    }
